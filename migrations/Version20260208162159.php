 ...
 */
final class Version20260208162159 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE depense (id INT AUTO_INCREMENT NOT NULL, montant DOUBLE PRECISION NOT NULL, categorie VARCHAR(255) NOT NULL, date DATE NOT NULL, type_paiement VARCHAR(255) NOT NULL, utilisateur_id INT NOT NULL, budget_id INT NOT NULL, INDEX IDX_34059757FB88E14F (utilisateur_id), INDEX IDX_3405975736ABA6B8 (budget_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE objectif (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, categorie VARCHAR(255) NOT NULL, statut VARCHAR(255) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_E2F86851FB88E14F (utilisateur_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE plan_action (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, priorite VARCHAR(255) NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, objectif_id INT NOT NULL, INDEX IDX_F39494E0157D1AD4 (objectif_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE suivi_sante (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, sommeil DOUBLE PRECISION NOT NULL, activite VARCHAR(255) NOT NULL, utilisateur_id INT NOT NULL, bilan_sante_id INT DEFAULT NULL, INDEX IDX_6C041248FB88E14F (utilisateur_id), INDEX IDX_6C0412484FE3D2F4 (bilan_sante_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE tache (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, priorite VARCHAR(255) NOT NULL, difficulte INT NOT NULL, statut VARCHAR(255) NOT NULL, deadline DATETIME DEFAULT NULL, task_space_id INT NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_938720756397B90C (task_space_id), INDEX IDX_93872075FB88E14F (utilisateur_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');

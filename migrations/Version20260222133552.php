 ...
 */
final class Version20260222133552 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE task_space (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, date_creation DATE NOT NULL, description VARCHAR(255) NOT NULL, duration INT NOT NULL, status VARCHAR(255) NOT NULL, utilisateur_id INT NOT NULL, INDEX IDX_EED6DA1AFB88E14F (utilisateur_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');

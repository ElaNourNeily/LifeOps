 ...
 */
class getSocialAuthenticatorService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Security\SocialAuthenticator' shared autowired service.
     *
     * @return \App\Security\SocialAuthenticator
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'SocialAuthenticator.php';
        ...
        if (isset($container->privates['App\\Security\\SocialAuthenticator'])) {
            return $container->privates['App\\Security\\SocialAuthenticator'];
        }

        $instance = new \App\Security\SocialAuthenticator(($container->services['knpu.oauth2.registry'] ??= new \KnpU\OAuth2ClientBundle\Client\ClientRegistry($container, ['google' => 'knpu.oauth2.client.google', 'facebook' => 'knpu.oauth2.client.facebook', 'github' => 'knpu.oauth2.client.github'])), $a, ($container->services['router'] ?? self::getRouterService($container)));

        if (isset($container->privates['App\\Security\\SocialAuthenticator'])) {
            return $container->privates['App\\Security\\SocialAuthenticator'];
        }

        return $container->privates['App\\Security\\SocialAuthenticator'] = $instance;
    }
}

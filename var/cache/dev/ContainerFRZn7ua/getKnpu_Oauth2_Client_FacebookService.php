 ...
 */
class getKnpu_Oauth2_Client_FacebookService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'knpu.oauth2.client.facebook' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['knpu.oauth2.client.facebook'] = new \KnpU\OAuth2ClientBundle\Client\Provider\FacebookClient(($container->privates['knpu.oauth2.provider_factory'] ?? $container->load('getKnpu_Oauth2_ProviderFactoryService'))->createProvider('League\\OAuth2\\Client\\Provider\\Facebook', ['clientId' => $container->getEnv('FACEBOOK_CLIENT_ID'), 'clientSecret' => $container->getEnv('FACEBOOK_CLIENT_SECRET'), 'graphApiVersion' => 'v2.12'], 'connect_facebook_check', [], []), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));
    }
}

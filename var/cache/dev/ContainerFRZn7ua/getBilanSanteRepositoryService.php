 ...
 */
class getBilanSanteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BilanSanteRepository' shared autowired service.
     *
     * @return \App\Repository\BilanSanteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BilanSanteRepository.php';

        return $container->privates['App\\Repository\\BilanSanteRepository'] = new \App\Repository\BilanSanteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

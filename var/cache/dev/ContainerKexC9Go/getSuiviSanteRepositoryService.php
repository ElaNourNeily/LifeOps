 ...
 */
class getSuiviSanteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SuiviSanteRepository' shared autowired service.
     *
     * @return \App\Repository\SuiviSanteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SuiviSanteRepository.php';

        return $container->privates['App\\Repository\\SuiviSanteRepository'] = new \App\Repository\SuiviSanteRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

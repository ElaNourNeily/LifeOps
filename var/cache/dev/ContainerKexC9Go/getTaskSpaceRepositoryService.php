 ...
 */
class getTaskSpaceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TaskSpaceRepository' shared autowired service.
     *
     * @return \App\Repository\TaskSpaceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TaskSpaceRepository.php';

        return $container->privates['App\\Repository\\TaskSpaceRepository'] = new \App\Repository\TaskSpaceRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}

...
class getSecurity_Firewall_Map_Context_MainService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->services['Symfony\\Component\\Security\\Http\\Authenticator\\FormLoginAuthenticator'] ?? $container->load('getFormLoginAuthenticatorService'));
        ...
        }, 4), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, ($container->privates['security.authentication.trust_resolver'] ??= new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver()), $c, 'main', $a, NULL, NULL, ($container->privates['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container)), false), new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $c, ($container->privates['debug.security.event_dispatcher.main'] ?? self::getDebug_Security_EventDispatcher_MainService($container)), ['csrf_parameter' => '_token', 'csrf_token_id' => 'logout', 'logout_path' => 'app_logout'], ($container->privates['security.csrf.token_manager'] ?? self::getSecurity_Csrf_TokenManagerService($container))), new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'App\\Security\\UserChecker', NULL, true, false, 'security.user.provider.concrete.app_user_provider', 'main', 'security.authenticator.form_login.main', NULL, NULL, ['form_login', 'remember_me', 'App\\Security\\SocialAuthenticator'], NULL, ['path' => 'app_logout', 'enable_csrf' => true, 'csrf_parameter' => '_token', 'csrf_token_id' => 'logout', 'target' => 'app_home', 'invalidate_session' => true, 'csrf_token_manager' => 'security.csrf.token_manager', 'clear_site_data' => [], 'delete_cookies' => []]), ($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()));

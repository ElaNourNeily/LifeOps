...
class getKnpu_Oauth2_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['knpu.oauth2.registry'] = new \KnpU\OAuth2ClientBundle\Client\ClientRegistry($container, ['google' => 'knpu.oauth2.client.google', 'facebook' => 'knpu.oauth2.client.facebook', 'github' => 'knpu.oauth2.client.github']);
    }
}
